...
var CountryListItem = function (_a) {
    ...
    return (React.createElement("li", { className: (selectedCountry === null || selectedCountry === void 0 ? void 0 : selectedCountry.name) === country.name ? "active currentItem" : '', ref: listItemRef },
