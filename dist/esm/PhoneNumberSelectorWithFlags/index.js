...
var PhoneNumberSelectorWithFlags = function () {
    ...
    return (React.createElement(ClickAwayListener, { onClickAway: handleClickAway },
        React.createElement("div", { className: "dropdownComponentWrapper" },
            React.createElement("div", { className: "selectedFlagHolder" },
                ...
                React.createElement("span", { className: "selectedPhoneCode" }, selectedPhoneCode),
            ...
            React.createElement("div", { className: "dropdownWrapper" }, open ? (React.createElement(CountryDropdown, { setSelectedPhoneCode: setSelectedPhoneCode, setSelectedFlag: setSelectedFlag, setOpen: setOpen, numberInputerRef: numberInputerRef, searchInputerRef: searchInputerRef, open: open })) : null))));
};
